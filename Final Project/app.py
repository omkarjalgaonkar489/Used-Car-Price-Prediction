...
df = pd.read_csv('C:/Users/omkar/Desktop/Final Project/templates/Car_data.csv')
df.to_csv('C:/Users/omkar/Desktop/Final Project/templates/Car_data.csv', index=None)

@app.route('/carrec')
def carrec():
    # converting csv to html
    data = pd.read_csv('C:/Users/omkar/Desktop/Final Project/templates/Car_data.csv')
    data.to_csv('C:/Users/omkar/Desktop/Final Project/templates/Car_data.csv', index=None)
